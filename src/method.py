...
class ListVacancies(Methods):
    ...
    def save_vacancies(vacancies):
        ...
        with open("../database/vacancies.json", "w", encoding="utf8") as f:
    ...
    def add_vacancy(self, name_vac):
        ...
        with open("../database/vacancies.json", "r", encoding="utf8") as f:
            list_vacancies = json.load(f)
        with open("../database/my_vacancies.json", "r", encoding="utf8") as f:
            list = json.load(f)
        ...
        with open("../database/my_vacancies.json", "w", encoding="utf8") as f:
